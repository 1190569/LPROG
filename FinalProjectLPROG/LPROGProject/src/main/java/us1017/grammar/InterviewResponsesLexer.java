...
public class InterviewResponsesLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "T__11", "T__12", "LPAREN", "RPAREN", "COMMA", "COLON", 
			"ID", "INT", "STRING", "TRUE", "FALSE", "HYPHEN", "FRACTION", "WS"
		};
	}
	...
	public InterviewResponsesLexer(CharStream input) {
		super(input);
